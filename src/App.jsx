      ...
      <div className="flex min-h-screen bg-white dark:bg-gray-900 transition-colors duration-200">
        ...
        <main className="flex-1 overflow-auto dark:text-white pt-14 pb-16">
          ...
          <button
            ...
            className={`fixed bottom-20 right-4 p-2 rounded-full bg-blue-600 text-white shadow-lg transition-all duration-300 hover:bg-blue-700 ${scrollProgress > 20 ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
