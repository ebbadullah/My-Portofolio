    ...
    <div className="py-12 px-5 bg-white dark:bg-gray-900">
      <div className="mx-auto max-w-md">
        <div className="text-center mb-8">
          <span className="inline-block px-3 py-1 mb-2 text-sm font-medium text-blue-600 dark:text-blue-400 bg-blue-100 dark:bg-blue-900/30 rounded-full">
            About Me
          </span>
        ...
        <div className="grid grid-cols-1 gap-4">
          {skills.map((skill) => (
            <div
              key={skill.name}
              className="bg-white dark:bg-gray-800 rounded-lg p-4 shadow-md transition-all duration-300 hover:shadow-lg"
            >
              ...
              <div className="h-2.5 w-full bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                <div
                  className="h-full bg-gradient-to-r from-blue-500 to-blue-600 dark:from-blue-600 dark:to-blue-400 rounded-full transition-all duration-1000 ease-out"
