          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start">
              ...
              <div className="ml-4">
                ...
                <p className="text-gray-600 dark:text-gray-300 mt-1">contact@ebadbaloch345@gmail.com</p>
              </div>
            </div>
          ...
          <div className="mt-8">
            ...
            <div className="flex space-x-4">
              ...
              <a
                ...
                className="bg-white dark:bg-gray-800 p-2 rounded-full shadow-sm hover:shadow-md transition-shadow"
              >
