...
export default function Home() {
    ...
    const phrases = ["MERN Stack Developer", "JavaScript Lover", "Building Scalable Apps"]
    ...
    return (
        <div className="flex flex-col justify-center items-start h-screen px-6 md:px-12 lg:px-24">
            <div className="relative z-10">
                ...
                <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-gray-900 dark:text-white mb-4 tracking-tight">EBAD ULLAH</h1>
                ...
                <div className="flex flex-wrap gap-4">
                    <button className="bg-blue-600 hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-800 text-white px-6 py-3 rounded-md font-medium flex items-center gap-2 transition-all duration-300 transform hover:translate-y-[-2px] hover:shadow-lg" onClick={() => document.getElementById("projects").scrollIntoView({ behavior: "smooth" })}>
                        View My Work
                        <ArrowRightIcon className="h-4 w-4" />
                    </button>

                    <button className="border-2 border-blue-600 text-blue-600 dark:border-blue-400 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/30 px-6 py-3 rounded-md font-medium transition-all duration-300 transform hover:translate-y-[-2px] hover:shadow-lg" onClick={() => document.getElementById("contact").scrollIntoView({ behavior: "smooth" })}>
                        Contact Me
                    </button>
                </div>
            </div>
