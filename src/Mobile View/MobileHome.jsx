        ...
        <div className="flex flex-col justify-center min-h-screen px-5 pt-14 pb-20 bg-gradient-to-b from-white to-blue-50 dark:from-gray-900 dark:to-gray-800">
            <div className="relative z-10 w-full max-w-md mx-auto">
                ...
                <div className="text-center mb-8">
                    <span className="inline-block px-3 py-1 mb-3 text-sm font-medium text-blue-600 dark:text-blue-400 bg-blue-100 dark:bg-blue-900/30 rounded-full">Hello, I'm</span>
                    <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2 tracking-tight">EBAD ULLAH</h1>
                ...
                <div className="bg-white dark:bg-gray-800 p-5 rounded-xl shadow-lg mb-8 text-center">
                    <p className="text-gray-700 dark:text-gray-300 leading-relaxed">I create responsive, user-friendly web applications with modern technologies. Let's build something amazing together.</p>
                </div>

                <div className="flex flex-col gap-3 w-full">
                    <button className="bg-blue-600 hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-800 text-white px-6 py-3 rounded-lg text-sm font-medium flex items-center justify-center gap-2 transition-all duration-300 shadow-md hover:shadow-lg" onClick={() => document.getElementById("projects").scrollIntoView({ behavior: "smooth" })}>
                        View My Work
                        <ArrowRightIcon className="h-4 w-4" />
                    </button>

                    <button className="border-2 border-blue-600 text-blue-600 dark:border-blue-400 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/30 px-6 py-3 rounded-lg text-sm font-medium transition-all duration-300 shadow-sm hover:shadow-md" onClick={() => document.getElementById("contact").scrollIntoView({ behavior: "smooth" })}>
                        Contact Me
                    </button>
                </div>
            </div>
